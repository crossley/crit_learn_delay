...
%DIF ADD main_revision.tex   Mon Oct 20 19:18:55 2025
...
$d=-.80$}\DIFaddend ).  Performance in the Control and Long-ITI
conditions did not differ significantly from each other
($t(25.97) = -1.50$, $p=.15$\DIFaddbegin \DIFadd{, $d=-.53$}\DIFaddend ).
...
-0.49$, $p = .63$, $\eta^2 = .01$}\DIFdelend \DIFaddbegin \DIFadd{$t(32.0) =
